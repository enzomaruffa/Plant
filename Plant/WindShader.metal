...
//  Plant
//
//  Created by Enzo Maruffa Moreira on 27/02/20.
...
//https://stackoverflow.com/questions/54403939/rewriting-an-android-opengl-filter-to-metal-for-cifilter

//https://www.shadertoy.com/view/Mdtczl

extern "C" {
    namespace coreimage {
        
        float4 compute(texture2d<float, access::write> output [[texture(0)]],
            ...
            uv.x += (cos(time - uv.x)-0.8) * 0.03 * uv.y;

            float3 col = texture(iChannel0, uv).rgb;
