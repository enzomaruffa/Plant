...
extension UIColor {
    ...
    func mix(with color: UIColor, andProportion firstProportion: CGFloat) -> UIColor {
        ...
        let red = (red2 * firstProportion + red1 * (1 - firstProportion)) / 2
        let blue = (blue2 * firstProportion + blue1 * (1 - firstProportion)) / 2
        let green = (green2 * firstProportion + green1 * (1 - firstProportion)) / 2
        let alpha = (alpha2 * firstProportion + alpha1 * (1 - firstProportion)) / 2
